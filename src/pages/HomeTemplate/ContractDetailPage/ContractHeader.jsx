...
export default function ContractHeader({ contract, onSignContract, onSignContractDirect }) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          {contract.status === 'pending_contract' && contract.otpRequired && (
            <>
              ...
              <button 
                onClick={onSignContractDirect}
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors shadow-lg hover:shadow-xl text-sm flex items-center"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
