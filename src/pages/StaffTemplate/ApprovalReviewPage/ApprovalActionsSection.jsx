        ...
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-green-800 mb-2">Xác nhận duyệt yêu cầu</h4>
              <p className="text-green-700 text-sm mb-4">
                Bạn có chắc chắn muốn duyệt yêu cầu thuê xe này? Hệ thống sẽ gửi thông báo và tạo hợp đồng điện tử cho khách hàng.
              </p>
      ...
      {showRejectForm && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-red-800 mb-2">Từ chối yêu cầu thuê xe</h4>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  placeholder="Nhập lý do từ chối yêu cầu thuê xe..."
                  rows={3}
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="text-gray-700 text-sm space-y-1">
                <li>• <strong>Nếu duyệt:</strong> Hệ thống sẽ gửi thông báo + tạo hợp đồng điện tử cho khách hàng</li>
                ...
                <li>• Xe sẽ chuyển trạng thái tương ứng sau khi xử lý</li>
              </ul>
            </div>
          </div>
        </div>
